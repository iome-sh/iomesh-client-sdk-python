...
optional docs wrap-up patch ([docs/WRAP_UP.md](docs/WRAP_UP.md)). Tag/publish after
the version PR; 1.0 only when [docs/1.0-bar.md](docs/1.0-bar.md) is met.
...
git tag -a v0.10.0 -m "v0.10.0: typing marker + API inventory + 1.0 bar docs"
git push origin v0.10.0
# optional docs patch:
# git tag -a v0.10.1 -m "v0.10.1: docs wrap-up closeout"
...
- Memory helpers: local sidecar HTTP plus optional sync (`sync=True`); a mesh-broker URL may 404 retrieve
- 0.x feature continuum closed at v0.10.0; 1.0 only when [docs/1.0-bar.md](docs/1.0-bar.md) gates are met
